...
<head>
    ...
    <meta name="google-site-verification" content="StYM1sKESNQwJFWnPoB0bp9RWBW-JVOp8mmjEW76A-c" />
    ...
    @else
        <meta name="description"
            content="Portal berita visual terdepan. Kami percaya satu foto mampu menceritakan kisah yang lebih dalam daripada ribuan kata.">
                ...
                <div class="flex items-center">
                    <form action="{{ url('/search') }}" method="GET" class="relative">
                        <input type="text" name="q" value="{{ request('q') }}" placeholder="Cari berita..."
                            class="w-36 sm:w-48 bg-gray-100 border-none rounded-full px-4 py-2 text-sm focus:ring-orange-500 focus:bg-white transition-all">
        ...
        <div class="border-b border-white/5 px-4 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto py-4">
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-[0.65rem] font-bold uppercase tracking-[0.2em] text-white/50">vnews.id</span>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        ...
                        @foreach (\App\Models\Category::all() as $footerCat)
                            <li class="min-w-0">
                                <a href="{{ route('category.show', $footerCat->slug) }}"
                                    ...
                                    <span
                                        class="w-3 h-px bg-orange-600 opacity-0 group-hover:opacity-100 transition-opacity shrink-0"></span>
            ...
            <div class="pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
                <p class="text-[0.7rem] text-white/25 tracking-wide">
                    &copy; {{ date('Y') }} <span class="text-white/40">vnews.id</span> &mdash; Seluruh hak cipta
                    visual dilindungi.
                </p>
